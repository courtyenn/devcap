...
let createMessage = ({start, creator, summary, htmlLink}, {full_name, last_customer_alignment, slack_id, status}) => {
  ...
  Our records show you haven't been in a Customer Support meeting ${moment(last_customer_alignment).toNow()}.
  ${creator.displayName} just created a meeting called, ${summary}, for ${start.dateTime_pretty}. <${htmlLink}|Take me to my Google Calendar> \n
  ...
  if(status === 'none'){
    ...
    \n\nA meeting was created by ${creator.displayName}. Join them for ${summary} on ${start.dateTime_pretty}. <${htmlLink}|Take me to my Google Calendar>
